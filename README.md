...
Limpieza de datos y dashboard que permite visualizar geográficamente las observaciones registradas en datasets de GBIF, se puede usar cualquier dataset de occurrences en formato CSV proporcionado por GBIF
